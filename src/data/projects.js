    ...
    apps: [
      {
        ...
        feedback: [
          '/assets/buyme-comment-1.jpg',
          '/assets/buyme-comment-2.jpg',
          '/assets/buyme-comment-3.jpg',
          '/assets/buyme-comment-4.jpg',
          '/assets/buyme-comment-5.jpg',
          '/assets/buyme-comment-6.jpg',
          '/assets/buyme-comment-7.jpg',
          '/assets/buyme-comment-8.jpg',
          '/assets/buyme-comment-9.jpg',
          '/assets/buyme-comment-10.jpg',
          '/assets/buyme-comment-11.jpg',
        ],
        gallery: [
      ...
      },
      {
        ...
        problem: [
          ...
          { heading: 'User Research Confirmed It' },
          'What started as a personal frustration turned out to be a common user experience.',
          {
            images: [
              '/assets/bit-others-2.jpg',
              '/assets/bit-others-1.jpg',
              '/assets/bit-others-3.jpg',
            ],
          },
    ...
    stats: [
      {
        icon: 'users',
        accent: 'blue',
        image: '/assets/scouts-figure-4.png',
        value: 110000,
        suffix: '+',
        label: 'Members',
      },
      {
        icon: 'tent',
        accent: 'green',
        image: '/assets/scouts-illus-5.png',
        imgSize: 120,
        value: 230,
        suffix: '+',
        label: 'Local branches (Shevatim)',
      },
      {
        icon: 'money',
        accent: 'gold',
        image: '/assets/scouts-illus-4.png',
        imgSize: 120,
        value: 483,
        suffix: '₪ million',
        label: 'Total revenue',
